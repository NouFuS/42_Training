...
Pour proposer un exercice:
     - Creer un dossier pour le module associe. Ex: Pour le module 'c00', creer un dossier '42_Training/NOM_UTILISATEUR/c00'
     - Creer le fichier attendu par l'exercice. Ex: Pour l'exercice 1, le ficher attendu est 'ft_putchar.c'. Il faut donc creer '42_Training/NOM_UTILISATEUR/c00/ft_putchar.c'.
